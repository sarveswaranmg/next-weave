...
celery_app.conf.beat_schedule = {
    "hourly-memory-evolution": {
        "task": "neurowave_engine.workers.tasks.hourly_memory_evolution",
        "schedule": crontab(minute=0),  # top of every hour
    },
    "daily-memory-evolution-sweep": {
        "task": "neurowave_engine.workers.tasks.daily_memory_evolution_sweep",
    ...
    "hourly-dream-tick": {
        "task": "neurowave_engine.workers.tasks.hourly_dream_tick",
        "schedule": crontab(minute=15),  # offset from memory-evolution's :00
    },
    "daily-dream-tick": {
        "task": "neurowave_engine.workers.tasks.daily_dream_tick",
        "schedule": crontab(hour=4, minute=0),  # 04:00 UTC daily
    },
    "weekly-dream-tick": {
        "task": "neurowave_engine.workers.tasks.weekly_dream_tick",
        "schedule": crontab(hour=5, minute=0, day_of_week=0),  # Sunday 05:00 UTC
    },
    "idle-triggered-dream-tick": {
        "task": "neurowave_engine.workers.tasks.idle_triggered_dream_tick",
